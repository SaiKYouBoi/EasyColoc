        ...
        <div class="w-full max-w-[440px] flex flex-col">
            ...
            <div
                ...
                <form method="POST" action="{{ route('login') }}" class="flex flex-col gap-5">
                    ...
                    <!-- Submit Button -->
                    <button
                        class="w-full h-11 mt-4 bg-primary hover:bg-opacity-90 active:scale-[0.98] text-slate-900 font-bold rounded-lg transition-all shadow-sm flex items-center justify-center gap-2"
                        type="submit">
                        <span>Sign In</span>
                ...
                <p class="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <a class="font-semibold text-primary-dark dark:text-primary hover:underline" href="{{ route('register') }}">Sign
                        up</a>
                </p>
            </div>
