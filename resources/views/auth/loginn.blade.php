        ...
        <div class="w-full max-w-[440px] flex flex-col">
            ...
            <div
                ...
                <div class="mb-8 text-center">
                    ...
                    <p class="text-slate-500 dark:text-slate-400 text-base">Enter your details to manage expenses.</p>
                </div>
                <!-- Google Sign In -->
                <button
                ...
                <form method="POST" action="{{ route('login') }} class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <div class="flex justify-between items-center ml-1">
                            ...
                            <a class="text-sm font-medium text-primary-dark dark:text-primary hover:underline"
                    ...
                    <!-- Submit Button -->
                    <button
                        class="w-full h-11 mt-2 bg-primary hover:bg-opacity-90 active:scale-[0.98] text-slate-900 font-bold rounded-lg transition-all shadow-sm flex items-center justify-center gap-2"
                        type="button">
                        <span>Sign In</span>
                ...
                <p class="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <a class="font-semibold text-primary-dark dark:text-primary hover:underline" href="{{ route('auth.register') }}">Sign
                        up</a>
                </p>
            </div>
