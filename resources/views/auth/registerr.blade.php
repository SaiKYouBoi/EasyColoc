            ...
            <div
                ...
                <form method="POST" action="{{ route('register') }} class="flex flex-col gap-5">
                    ...
                    <div class="flex flex-col gap-1.5">
                        <label class="text-sm font-semibold text-slate-700 dark:text-slate-300 ml-1" for="fullname">Full
                            Name</label>
                ...
                <p class="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
                    ...
                    <a class="font-semibold text-primary-dark dark:text-primary hover:underline" href="#">Log
                        in</a>
                </p>
            </div>
